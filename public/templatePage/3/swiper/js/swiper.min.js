      ...
      getTranslate: function (e, t) {
        ...
        return (
          s.WebKitCSSMatrix
            ...
            : (a = (r = n.MozTransform || n.OTransform || n.MsTransform || n.msTransform || n.transform || n.getPropertyValue('transform').replace('translate(', 'matrix(1, 0, 0, 1,'))
                .toString()
                .split(',')),
      ...
      update: function () {
        ...
        if (i.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
          ...
          if (
            ...
            if (
              (i.dynamicBullets &&
                ((t.pagination.bulletSize = l.eq(0)[t.isHorizontal() ? 'outerWidth' : 'outerHeight'](!0)), n.css(t.isHorizontal() ? 'width' : 'height', 5 * t.pagination.bulletSize + 'px')),
