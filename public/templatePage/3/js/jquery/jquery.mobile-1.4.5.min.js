    ...
    (function (a) {
      ...
      a.widget('mobile.loader', {
        ...
        checkLoaderPosition: function () {
          ...
          (b.top < c || b.top - c > d) &&
            (this.element.addClass('ui-loader-fakefix'), this.fakeFixLoader(), this.window.unbind('scroll', this.checkLoaderPosition).bind('scroll', a.proxy(this.fakeFixLoader, this)));
        },
        resetHtml: function () {
      ...
      a.widget('mobile.pagecontainer', {
        ...
        _loadSuccess: function (b, c, e, f) {
          ...
          return a.proxy(function (h, i, j) {
            ...
            l.test(h) && RegExp.$1 && m.test(RegExp.$1) && RegExp.$1 && ((g = a.mobile.path.getFilePath(a('<div>' + RegExp.$1 + '</div>').text())), (g = this.window[0].encodeURIComponent(g))),
              ...
              this._triggerWithDeprecated('load', c).event.isDefaultPrevented() ||
                (this._isRewritableBaseTag() && k && this._getBase().rewrite(g, k), this._include(k, e), e.showLoadMsg && this._hideLoading(), f.resolve(b, e, k));
          }, this);
        },
        _loadDefaults: {
          type: 'get',
